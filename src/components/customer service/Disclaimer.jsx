      ...
      <div className="p-16">
        <div className="flex justify-center flex-col p-5 shadow-md border border-gray-200 rounded-sm">
          ...
          <p className="text-l m-3">
            ...
            support@ijstartprinter.us.
          </p>

          <h3 className="text-2xl m-2">Disclaimers for ijstartprinter.com</h3>
          <p className="text-l m-3">
            ...
            ijstartprinter does not make any warranties about the completeness,
            reliability and accuracy of this information. Any action you take
            upon the information you find on this website (ijstartprinter), is
            strictly at your own risk. ijstartprinter will not be liable for any
